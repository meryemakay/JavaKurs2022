...
public class C01_substring {
    public static void main(String[] args) {
        ...
        System.out.println(str.substring(9)); // yazilan index inclusive(dahıl)
        ...
        System.out.println(str.substring(0,5)); // Java 5 ı almıyor
        System.out.println(str.substring(0,1)); // J
        String harf=str.substring(5,6); // bana 6.karakter String olarak bulun i
