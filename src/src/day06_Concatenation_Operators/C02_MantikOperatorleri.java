...
//!= est degldir
//hepsı true old ıcın sonuc true
        System.out.println(sonuc1); // true


        boolean sonuc2 = 5>4 && 7>9 && 6+3==9 && 5+2!=8 ;

// 1 tane false old için sonuc false
        System.out.println(sonuc2); // false

        boolean sonuc3 = 5>4 & 7>9 & 6+3==9 & 5+2!=8 ;

//tek & olunca da false oldu

        System.out.println(sonuc3); // false


        // && ile & arasindaki fark
//tek & hepsıne bakar . && ise ılk false de duru ve false verr sunucu
        ...
        //araya && koymak lazım aralıktan bahsedyorsk
...
//olmadıgını gostrmek ıcın de || kullnlmlı
