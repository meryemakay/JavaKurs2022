...
public class C01_iterator {
    public static void main(String[] args) {
        ...
        itr.remove(); //7 yi sildi elinde olan elemani siler/ son olarak 7 yi almisti
        System.out.println(liste);//[5, 8, 6, 9]
        // itr.remove(); hata verir cunku elinde eleman yok/ nex demek lazimdi illegal exceptıon fırlattı

//iterator in 3 methodu var next hasnext ve remove !!!!
