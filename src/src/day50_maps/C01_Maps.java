    ...
    public static void main(String[] args) {
        {
            ...
            System.out.println(sinifListMap);//{101=Ali, Can, Dev ,1453, 102=Veli, Yan, QA,1990, 103=Ali, Yan, C#,2000}
         ...
         */
            ...
            System.out.println(sinifValueColl);//[Ali, Can, Dev ,1453, Veli, Yan, QA,1990, Ali, Yan, C#,2000]
            System.out.println(sinifValueColl.size());//3

            List<String> sinifValueList=new ArrayList<>();
            sinifValueList.addAll(sinifValueColl);

            System.out.println(sinifValueList);//[Ali, Can, Dev ,1453, Veli, Yan, QA,1990, Ali, Yan, C#,2000]
         ...
         */
            ...
            int outerArrayBoyut= sinifValueList.size();//3


            // inner array'lerin boyutunu bulmak biraz daha kompleks olacak

            String ilkValue=sinifValueList.get(0);
            System.out.println("ilk value "+ ilkValue);//ilk value Ali, Can, Dev ,1453
            ...
            System.out.println("md array " + Arrays.deepToString(valueMDArr));//md array [[Ali, Can, Dev ,1453], [Veli, Yan, QA,1990], [Ali, Yan, C#,2000]]
            ...
            System.out.println("Numara  Isim   Soyisim  Brans  Dogum yılı");
