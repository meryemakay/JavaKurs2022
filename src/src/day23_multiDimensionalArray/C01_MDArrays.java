package src.day23_multiDimensionalArray;
...
public class C01_MDArrays {
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(arr)); // [[I@58ceff1, [I@7c30a502] icinde iki tane array var
                                                   //her array ın ref ını yazdırdı
